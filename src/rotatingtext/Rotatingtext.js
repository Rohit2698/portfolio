...
class ReactRotatingText extends React.Component {
  ...
  _erase(callback) {
    ...
    // set the str]ing one character shorter
...
ReactRotatingText.defaultProps = {
  ...
  emptyPause: 1000,
  eraseMode: 'erase',
  items: ['Doing MCA From VIT Vellore', 'Working to Become a Full Stack Web Developer', 'And Believe Me I will Become..', 'OneDay', 'Do you know What I Love "Writing"'],
  pause: 1500,
  typingInterval: 100,
  random: false
};
